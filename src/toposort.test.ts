...
describe("getRootsAndNonRoots", () => {
    ...
    test("5", () => {
        let callFunction: any = () => {
            getRootsAndNonRoots({ size: Infinity })
        }
